...
def researcher_profile(researcher_id):
    ...
    try:
        # Get researcher details (we'll need to add this function)
        ...
        # Calculate stats
        total_sessions = 0  # Would need a function to calculate this
        publications = []  # Would need a publications table/function
        recent_activity = []  # Would need an activity tracking function
...
# Person route removed - using researcher profile instead

# Event route removed - using experiment detail instead
